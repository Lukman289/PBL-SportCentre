    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <motion.div 
          ...
          variants={fadeInUp}
        >
          <h2 className="text-4xl font-bold mb-4">Cara Bergabung</h2>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  ...
                  <div className="bg-gradient-to-br from-primary to-primary/80 text-white w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold relative z-10 shadow-lg shadow-primary/20">
                    {step.number}
                  </div>
                </div>
                
                {/* Content */}
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-white/20 hover:shadow-md transition-all w-full">
        ...
        >
          <Link href="/auth/register?role=owner">
            <Button size="lg" className="gap-2 px-8 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all">
              Mulai Sekarang <ArrowRight className="w-4 h-4 animate-pulse" />
            </Button>
          </Link>
        </motion.div>
      </div>
